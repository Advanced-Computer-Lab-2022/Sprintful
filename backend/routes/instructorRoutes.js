...
const { createInstructor, changePassword, addInstructorReview, getInstructorRating,
    createChoice, createQuestion, createTask, getInstructorProfile ,login, editBioEmailPassword, logout, getAmount,checkMyOwnCourse} = require('../controllers/instructorController')
