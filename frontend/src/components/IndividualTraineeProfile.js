               ...
               <div className="card mb-4">
                 <div className="card-body">
                   ...
                   {/* <div className="row">
                    ...
                    <br/>
                      <button style={{width: "150px", textAlign: "center", justifyContent: "center", marginLeft: "69.8em", height: "30px", fontSize: "14px"}} onClick={()=> navigate(`/api/individualTrainee/changePassword?id=${id}`)}>Change Password</button>
