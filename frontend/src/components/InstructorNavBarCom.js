    ...
    return (
        <nav className="main-nav" style={{background: "white", height: "20px"}}>
            ...
            <ul className="nav" style={{width: "1360px"}}>
                ...
                <li><a onClick={()=>window.location.href =`/instructor?id=${id}`} style= {{color: "black",  marginTop:-2, fontFamily: "Times New Roman"}}>Home</a></li>
                <CountryCom />
                <li><a onClick={() => window.location.href = `/MyTaughtCourses?id=${id}`} style= {{color: "black",  marginTop:-2, fontFamily: "Times New Roman"}}>My Courses</a></li>
                <MostPopular/>
                <li></li>   
                 <li></li>
                 <li></li>   
