...
const ReportDetails = () => {
    ...
    return (
        <div>
            ...
            <div id="page-wrapper" style={{width: "1200px", height: "600px",left: "100px", margin: 70, background: "#DCDCDC"}} >
             <br/>
        ...
        <div  onClick={()=> navigate(`/api/corporateTrainee/ViewReports?id=${id}`)} style={{color: 'white', 
             padding: '15px 50px 5px 50px',
             float: 'left',
