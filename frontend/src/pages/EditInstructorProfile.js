         ...
         <div id="page-wrapper" style={{width: "1200px", height: "800px",left: "100px", margin: 70, background: "#DCDCDC" ,marginTop:"-200px"}} >
          ...
          <div id="page-inner" style={{width: "1100px", height: "700px", margin: 40, background: "white"}}>
             ...
             <div className="container">
                ...
                <div style={header}>Edit my Profile</div>
                <br/>
  <br/>
      <div>
      ...
      <div className="EditInstructorProfile">
        ...
        <label style={{color: "black", fontFamily: "Times New Roman"}}>Biography: </label>
            <input style = {{ //.create input, .create textarea, .create select
                    padding: "6px 10px",
                    margin: "10px 0",
                    height: "6em",
      ...
      <br/>
        ...
        <div  onClick={()=> navigate(`/api/instructor/getProfile?id=${id}`)} style={{color: 'white', 
             padding: '15px 50px 5px 50px',
             float: 'left',
