...
const ChangeCorporateTraineePassword = () => {
  ...
  <br/>
      ...
      <p style= {{ marginLeft: "540px", fontSize:"16px", color:"black"}}>
            ...
            <label style={{fontSize:"16px", color:"black", textAlign: "center", fontFamily: "Times New Roman"}}>{corporateTrainee.username}</label>
            </p>
         {/* <!-- ***** Header Area End ***** --> */}
...
<label style={{color: "black", fontFamily: "Times New Roman"}}>New Password: </label>
    <input style = {{ //.create input, .create textarea, .create select
        ...
        <div  onClick={()=> navigate(`/api/corporateTrainee/getProfile?id=${id}`)} style={{color: 'white', 
             padding: '15px 50px 5px 50px',
             float: 'left',
