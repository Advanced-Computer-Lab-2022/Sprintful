  ...
  const navigate=useNavigate();
       ...
       //const id = "63897f88f459b2631346deee";
        ...
        const openReport = () => {
          ...
          setReportid(a)
          navigate(`/api/individualTrainee/ReportDetails/${reportid}`)
        }
...
<div className="card-container">
                        {reports  && reports.map((report) =>( 
                            <div className="card" onClick={()=>navigate(`/api/individualTrainee/ReportDetails?reportid=${report._id}&id=${id}`)} style={{height: "15em", cursor: "pointer"}}  >
